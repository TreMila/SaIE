...
Text: "Our president has put homeland security in the hands of failed Republican hacks." Entity span: [Republican, Our president]
...
run(input_list, merged_golds,'alpaca_33B_en')