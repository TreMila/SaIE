...
def run(input_list, input_list2eve, event_extend_map, cots, mode):
    for idx, example in tqdm(enumerate(input_list), total=len(input_list), desc="Processing..."):
        ...
        for e in event_extend:
            ...
            backward_details_path = f'./results/details_{mode}_test.txt'
...
run(input_list, input_list2eve, event_extend_map, cots, 'llama2_70B_en')
run_gold(input_list, input_list2eve, cots, 'llama2_70B_en')
