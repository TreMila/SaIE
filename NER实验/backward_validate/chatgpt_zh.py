...
with open('./data/final_entity_extend_map_zh.json','r',encoding='utf-8') as f:
...
def run(input_list, input_list2ent, entity_extend_map, cots):
        ...
        for ent in ent_extend:
            while 1:
                try:
                    ...
                    backward_details_path = './results/details_zh.txt'
...
run(input_list, input_list2ent, entity_extend_map, cots)