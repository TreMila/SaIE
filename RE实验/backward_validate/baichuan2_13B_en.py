...
# run(input_list, input_list2rel, cot_spos, cot_examples, rel_extend_map, 'baichuan2_13B_en')
run_gold(input_list, input_list2rel, cot_spos,cot_examples, 'baichuan2_13B_en')
