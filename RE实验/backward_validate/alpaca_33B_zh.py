...
# run(input_list, input_list2rel, cot_spos,cot_examples,rel_extend_map, 'alpaca_33B_zh')
run_gold(input_list, input_list2rel, cot_spos,cot_examples, 'alpaca_33B_zh')