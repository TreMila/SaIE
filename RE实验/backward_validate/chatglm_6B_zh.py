...
# run(input_list, input_list2rel, cot_spos,cot_examples,rel_extend_map, 'chatglm_6B_zh')
run_gold(input_list, input_list2rel, cot_spos,cot_examples, 'chatglm_6B_zh')